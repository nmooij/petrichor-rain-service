...
from vsdk.service_development.models import UserInput, session, user, dashboard_config_model
...
#####Donut#####
    ...
    objects_with_category_id_1 = UserInput.objects.filter(category_id=1)
	
    for obj in objects_with_category_id_1:
        data =  {'label': obj.input_description, #TO DO CHANGE TO farmerID ->userinput >session_id >session >caller_id >caller >name
                 'value': obj.input_value}# change to count input row
